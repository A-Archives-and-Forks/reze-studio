 ...
 *
 *  Ported from reze-design's editor/floating-panel, minus the fullscreen mode
 *  and the z-order stack — reze-studio has exactly one floating surface, so a
 *  single fixed layer is the whole stacking story. That layer sits BELOW the
 *  z-50 Radix uses for dialogs and menus: a modal is modal, and a reference
 *  video that covered the PMX picker would be in the way of the thing that put
 *  it on screen. */
