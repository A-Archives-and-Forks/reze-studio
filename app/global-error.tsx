...
// stylesheet. Nothing from layout.tsx is mounted here, which is why CrashScreen
// reads the locale from the browser rather than from any provider.
...
export default function GlobalError({
  ...
  return (
    <html lang="en" className="dark h-full antialiased">
      ...
      <title>Reze Studio — something broke</title>
